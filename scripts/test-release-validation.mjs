...
import { ARTIFACTS, SIGNED_ZIP_ENTRIES } from "./release-contract.mjs";
...
async function createFixture(root, fixture, { extraZipEntry = null } = {}) {
  ...
  const manifest = {
    schemaVersion: 1,
    kind: "nagu-codex-quota-monitor-public-release",
    product: "Codex Quota Monitor",
    version: "1.5.0",
    status: "fixture",
    hashAlgorithm: "SHA-256",
    source: { privateRcTag: null, privateCommit: null, publicCommit: null },
...
try {
  ...
  console.log("Fixture tests passed: valid inventory accepted; missing signature, tampering, forbidden source, and premature publication rejected.");
} finally {
